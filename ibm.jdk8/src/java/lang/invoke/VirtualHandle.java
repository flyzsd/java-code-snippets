...
final class VirtualHandle extends IndirectHandle {
	...
	VirtualHandle(Method method) throws IllegalAccessException {
		super(virtualMethodType(method), method.getDeclaringClass(), method.getName(), KIND_VIRTUAL, method.getModifiers());
	...
	VirtualHandle(DirectHandle nonVirtualHandle) throws IllegalAccessException {
		super(nonVirtualHandle.type(), nonVirtualHandle.definingClass, nonVirtualHandle.name, KIND_VIRTUAL, nonVirtualHandle.rawModifiers);
