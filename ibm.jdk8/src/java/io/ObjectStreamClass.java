...
public class ObjectStreamClass implements Serializable {
    ...
    /**
     * This is required by ORB for performance optimization.Functionality is same as getSerializableConstructor
     * except for Collection classes where it returns the constructor of the Collection class themselves rather
     * than returning no-arg constructor of superclass
     */
   
     private static Constructor getSerializableCollectionConstructor(Class<?> cl) {
         Class<?> initCl = cl;
         while (Serializable.class.isAssignableFrom(initCl)) {
            if ((initCl = initCl.getSuperclass()) == null) {
                return null;
            } else if (initCl == java.util.LinkedList.class
                    || initCl == java.util.ArrayList.class
                    || initCl == java.util.HashMap.class
                    || initCl == java.util.Hashtable.class
                    || initCl == java.util.LinkedHashMap.class
                    || initCl == java.util.HashSet.class
                    || initCl == java.util.LinkedHashSet.class) {
                break;
            }
        }
        try {
