...
abstract class IntPipeline<E_IN>
   ...
   protected static native void promoteGPUCompile();
    ...
    public void forEach(IntConsumer action) {
        ...
        boolean instanceOfRangeIntSpliterator = sourceSpliterator instanceof Streams.RangeIntSpliterator;
        if (instanceOfRangeIntSpliterator) { 
            Streams.RangeIntSpliterator intRange = (Streams.RangeIntSpliterator)sourceSpliterator;
