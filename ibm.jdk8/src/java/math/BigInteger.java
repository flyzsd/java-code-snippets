...
public class BigInteger extends Number implements Comparable<BigInteger>,
    ...
    final void cutOffLeadingZeroes() {
        ...
        // Remove redundant zeros to avoid resulting in non-canonical internal 
        // representation of BigInteger, which may cause wrong hash code and
        // some algorithm error.
        for (int i = numberLength + 1; i < digits.length; i++) {
            digits[i] = 0;
        }
    }
    ...
    private void readObject(ObjectInputStream in) throws IOException,
        ...
        if (magnitude.length == 0) {
            ...
            sign = signum;
            putBytesPositiveToIntegers(magnitude);
            firstNonzeroDigit = firstNonzeroByteNum;
            cutOffLeadingZeroes();
        }
    }
