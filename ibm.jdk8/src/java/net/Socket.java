...
class Socket implements java.io.Closeable {
    ...
    private Socket(SocketAddress address, SocketAddress localAddr,
        ...
        if (address instanceof InetSocketAddress) {
            setImpl(SocketAction.CONNECT, ((InetSocketAddress)address).getAddress(),
            		((InetSocketAddress)address).getPort(), true); // RDMA_CAPABILITY
        }
    ...
    public void connect(SocketAddress endpoint, int timeout) throws IOException {
        ...
        if (providerSwitchDone && netProvider.getPreferredAddress() != null) {
        	if (addr.isAnyLocalAddress() || addr.isLoopbackAddress()) {
        		...
        		epoint = new InetSocketAddress(addr, port);
        	}
        }                                                                    // RDMA_CAPABILITY
    ...
    public SocketAddress getLocalSocketAddress() {
       InetAddress la;
       if (!isBound() || (la = getLocalAddress()) == null)
           return null;
       return new InetSocketAddress(la, getLocalPort());                       //IBM-aix_connection_reset_error
    }
